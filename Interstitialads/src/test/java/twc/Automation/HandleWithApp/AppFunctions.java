...
public class AppFunctions extends Drivers{
	...
	static int startY;
	static int endY;
	public static String TestName="Smoke_Test_NextGen_IM_adunit";	
...
//
	...
	public static void Swipe_Conter_daily(int Counter) throws Exception{
	...
	public static void reset_App() throws Exception{
...
//        }
    ...
    public static void JavaReminder() {
...
//			}
	...
	public static void putTestMode() throws Exception{
	...
	try {
			List<WebElement> settings=Ad.findElementsByClassName("android.widget.CheckedTextView");	
		...
		//clicking 10 times on build number
		try {
		for(int i=1;i<10;i++) {
	...
	public static void enter_nextgenIm_ad_location() throws Exception
	{
	   ...
	   Ad.findElementByAccessibilityId("Search").click();
	    ...
	    Thread.sleep(2000);	
	    if(TestName.equalsIgnoreCase("Smoke_Test_NextGen_IM_adunit"))
	    {
	    //enter the zip code in text area
	    try {
	    Ad.findElementById("com.weather.Weather:id/search_text").sendKeys("caves spring");
	    Thread.sleep(2000);
	    }
	    catch(Exception e) {
	    	 Ad.findElementById("com.weather.Weather:id/search_text").sendKeys("caves spring");
	    	...
	    	//enter the zip code in text area
		    try {
		    Ad.findElementById("com.weather.Weather:id/search_text").sendKeys("Woodenbridge Township");
		    Thread.sleep(2000);
		    }
		    catch(Exception e) {
		    	 Ad.findElementById("com.weather.Weather:id/search_text").sendKeys("Woodenbridge Township");
	    ...
	    List<WebElement> ele=Ad.findElementsById("com.weather.Weather:id/search_item_container");
		ele.get(0).click();
		Thread.sleep(2000);
	...
	public static void enable_responsive_mode() throws Exception {
		putTestMode();
