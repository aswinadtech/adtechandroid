...
public class CharlesFunctions extends Drivers{
	...
	public static void openCharlesBrowser() throws IOException, Exception{
		...
		profile.setPreference("network.proxy.http", "192.168.1.6");
	...
	public static void ClearSessions() throws Exception{
		System.out.println("clearing the charles the charles session");
		Drivers.logStep("clearing the charles the charles session");
	...
	public static void ExportSessions() throws Exception{
		...
		System.out.println("Exporting the charles session");
		Drivers.logStep("Exporting the charles session");
		//FileUtils.cleanDirectory(new File(properties.getProperty("downloadPath"))); 
		String[][] charlesdata = read_excel_data.exceldataread("Charlesdeatils");
		Thread.sleep(1000);
...
//		Thread.sleep(1000);
	...
	public static void app_download_from_hockeyapp() throws InterruptedException, IOException{
		...
		Thread.sleep(150000);
		 ...
		 set_app_path();
	//	driver.findElement(By.id("user_email")).sendKeys("kvelappan@weather.com");	.	driver.findElement(By.id("user_password")).sendKeys("300interstate");
